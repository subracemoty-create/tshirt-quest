...
import BabiesSizeSelector from './BabiesSizeSelector'
...
function buildWhatsAppMessage(order) {
  ...
  const text = `היי! אני רוצה להזמין בגד גוף לתינוק מאתר T-SHIRT QUEST 🎮

פרטי ההזמנה שלי:
👶 קטגוריה: תינוקות (אוברול)
👕 מידה: ${order.selectedSize}
🔢 כמות: ${order.quantity}
🎨 צבע: ${colorName}
${designDetails}
📋 *העיצוב המדויק שלך הועתק אוטומטית! פשוט תעשה 'הדבק' (Paste / Ctrl+V) פה בצ'אט כדי לצרף את תמונת העיצוב להזמנה.*`

  return text
}

export default function BabiesOrderSelector({
